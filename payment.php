                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>100</td>
                                        <td>#98000</td>
                                        <td><span class="label label-sm label-danger">Not Paid</span></td>
                                    </tr>
                                   
                                    </tbody>
                                </table>

                                <a href="paymentgateway.php" ><input type="button" value="Make Payment" class="btn btn-success"></a>
                            </div>
                        </div>
                    </div>
                </div>
