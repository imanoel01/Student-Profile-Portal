...
if(isset($_SESSION['matricno'])){
   ...
   if (mysqli_num_rows($result) > 0) {
    ...
    $query=mysqli_query($mysqli, "select * from medical where Matricno='$matricno'");
                            ...
                            <div class="panel ">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                      <i class="fa fa-fw ti-pencil"></i> Medical Profile
                                     </h3>
                                ...
                                <div class="panel-body">
                                    <form action="medical_code.php" class="form-horizontal" method="post">
                                       
                                        <div class="panel">

                                            <div class="form-body">
                                            <div class="form-group">
                                               <label class="control-label col-sm-6"> Health Details</label>
                                             </div>
                                            <div class="form-group">
                                               <label for="" class="control-label col-sm-5" > Blood Group</label>
                                                    
                                                <div class="col-sm-5">
                                                    <select id="example-select1" name="bloodgroup"
                                            ...
                                            <div class="form-group">
                                                <label for="" class="control-label col-sm-5" > Genotype</label>
                                                        
                                                <div class="col-sm-5">
                                                    <select id="example-select1" name="genotype"
                                                                    class="form-control" size="1">
                                                                <option value="0">
                                                                    Please select
                                                                </option>
                                                    ...
                                                    <div class="form-group">
                                                    <label for="" class="control-label col-sm-5" > Health Status</label>

                                                    <div class="col-sm-5">
                                                    <select id="example-select1" name="healthstatus"
                                                                    class="form-control" size="1">
                                                                <option value="0">
                                                                    Please select
                                                                </option>
                                                                <!-- <option value="Abia">EXCELLENT</option> -->
                                            ...
                                            <div class="form-group">
                                                <label for="alergies" class="control-label col-sm-5">Allergies</label>
                                                <div class="col-sm-5">
                                                    <input type="text" name="allergies" class="form-control" id="">
                                                 </div>
                                            ...
                                            <div class="form-group">
                                                <input type="submit" name="Submit" value="Add" class="col-md-offset-2 btn btn-primary" <?php if($isexist==1) echo "style='display:none';"; ?>>
                                    ...
                                    <form action="medical_code.php" class="form-horizontal" method="post">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="form-group">
                                                <label for="alergies" class="control-label col-sm-5">Allergies</label>
                                                <div class="col-sm-5">
                                                    <input type="text" value="<?php  if($isexist==1){echo $allergies;} ?>" name="allergies" class="form-control" id="" readonly>
                                                 </div>
