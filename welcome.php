...
if(isset($_SESSION['matricno'])){
        ...
        $paddress=$pcity= $pstate=$taddress=$tcity=$tstate="nil";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $isaddress=false;
            $checkaddress=mysqli_query($mysqli,"select * from addresstbl where Matricno='$matricno'");
            if(mysqli_num_rows($checkaddress) > 0){
                $isaddress=true;

                        $query1=mysqli_query($mysqli,"select * from addresstbl where Matricno='$matricno' and Status='1'");
                    $query2=mysqli_query($mysqli,"select * from addresstbl where Matricno='$matricno' and Status='2'");
                                        ...
                                        <div class="panel-body">
                                            <form action="#" class="form-horizontal">
                                                <div class="form-body">
                                                    ...
                                                    <div <?php if(!$isaddress){echo "style='display:none';"; }?>} >
                                                    <h3>Address</h3>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static">
                                                                    <?php if($isaddress){ echo $paddress; }?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static">
                                                                    <?php if($isaddress){echo $taddress;} ?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static"><?php if($isaddress){echo $pcity;} ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static"><?php if($isaddress){echo $tcity;} ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static"><?php if($isaddress){echo $pstate;} ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <p class="form-control-static"><?php if($isaddress){echo $tstate;} ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
