                                ...
                                <div class="col-md-6">
                                    <div class="panel ">
                                        ...
                                        <div class="panel-body">
                                            <form action="address_code.php" class="form-horizontal" method="post">

                                            <div class="panel">
                                                <div class="form-body">
                                                <div class="form-group">
                                                   <label class="control-label col-sm-6">Permanent Address</label>
                                                </div>
                                                   <div class="form-group">

                                                    <label for="" class="control-label col-sm-3" > Address</label>
                                                    <div class="col-sm-6">
                                                    <input  type="text" class="form-control" name="paddress" placeholder="Address" id="">
                                                    </div>
                                                    </div>
                                                   <div class="form-group">
                                                   ...
                                                   <div class="col-sm-6">
                                                   <input type="text" class="form-control" name="pcity" placeholder="Town" id="">
                                                   </div>
                                                   </div>
                                                   ...
                                                   <div class="col-sm-6">
                                                   <select id="example-select1" name="pstate"
...
<div class="panel">
                                                <div class="form-body">
                                                   <div class="form-group">
                                                   <label for="" class="control-label col-sm-6"> Temporary Address</label>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <label for="" class="control-label col-sm-3" > Address</label>
                                                    <div class="col-sm-6">
                                                    <input  type="text" class="form-control" name="taddress" placeholder="Address" id="">
                                                    </div>
                                                    </div>
                                                   <div class="form-group">
                                                   <label for="" class="control-label col-sm-3" > City</label>
                                                   ...
                                                   <div class="col-sm-6">
                                                   <input type="text" class="form-control" name="tcity" placeholder="Town" id="">
                                                   </div>
                                                   </div>
                                                   ...
                                                   <div class="col-sm-6">
                                                   <select id="example-select1" name="tstate"
                                                                class="form-control" size="1">
                                                            <option value="0">
                                                                Please select
                                                            </option>
...
<div>
														<input type="submit" name="Submit" value="Add" class="btn btn-primary" <?php if($isexist==1) echo "style='display:none';"; ?>>
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="panel ">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">
                                                <i class="fa fa-fw ti-pencil"></i> Student Address Details
                                            </h3>
                                            <span class="pull-right hidden-xs">
                                                      <i class="fa fa-fw ti-angle-up clickable"></i>
                                                      <i class="fa fa-fw ti-close removepanel clickable"></i>
